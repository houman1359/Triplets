...
function [h,stderr] = mixedvineentropy(vine,alpha,erreps,cases,cop)
...
while stderr >= erreps
    ...
    figure(100)
    subplot(1,2,1);hold on;plot(k,h,'*')
    subplot(1,2,2);hold on;plot(k,stderr,'O')
    drawnow
