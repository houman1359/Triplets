...
function [info,stderr] = mixedvineinfo_New(PP,pcond,alpha,erreps,cases,snn,ygv)
...
for i = 1:ncond
    ...
    [hcond,stderrcond] = mixedvineentropy_New(PP,errepscond,cases,snn,ygv);
    info = info - pcond(1,i) * hcond;
    stderr = 0;%stderr + pcond(1,i) * stderrcond;
end
